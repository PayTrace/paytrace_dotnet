...
namespace PayTrace.Integration
{
    public class TransactionRequest
    {
        ...
        public Response ExportTransactions(DateTime startdate, DateTime enddate)
        {
            Request request = new Request(Destination);
            request = AddAuthorization(request);
            request[Keys.SDATE] = startdate.ToShortDateString();
            request[Keys.EDATE] = enddate.ToShortDateString();
            request[Keys.METHOD] = Methods.ExportTransactions;
